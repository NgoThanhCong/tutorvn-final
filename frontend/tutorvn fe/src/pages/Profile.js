...
const Profile = () => {
  ...
  const [currentJob, setCurrentJob] = useState("");
    ...
    <TextArea placeholder="FullName" autoSize onChange={(e) => {
      ...
      <br />
      <br />
      <Radio.Group name="radiogroup" defaultValue={1} onChange={
        //onChange
        ()=>{}
        }   >
      ...
      <br />
      <br />
      <Radio.Group name="radiogroup2" defaultValue={1} onChange={
       // onChangeGraduated
       ()=>{}
        }  >
      ...
      <DatePicker defaultValue={dayjs('2015/01/01', dateFormat)}
        placeholder="BirthDay" format={dateFormat} onChange={ ()=>{}
            // onChangeBirthDay
            }  />
      <br />
      <br />
      <TextArea rows={4} placeholder="Current Job" maxLength={400} onChange={
         ()=>{}
        //onChangeCurrentJob
        } />
      <br />
      ...
      <TextArea rows={4} placeholder="Description your experients" maxLength={400} onChange={
       // onChangeExperiences
       ()=>{}
        } />
      <br />
