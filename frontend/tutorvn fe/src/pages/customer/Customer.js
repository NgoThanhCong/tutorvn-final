...
const Customer = () => {
    ...
    const onDeleteTutor = async () => {
        ...
        await axios.get("http://localhost:8080/api/customer/delete/" + customerList[index].id, {
            headers: {
                'Authorization': `Bearer ${access_token}`
            }
            }).then
    ...
    return (
        ...
        <div class="bg-sky-700 container mx-auto px-4 sm:px-8">
            <div class="py-8">
                <div>
                    <h2 class="text-2xl text-white font-semibold leading-tight">List Customer</h2>
                </div>
