...
const DetailCustomer = () =>
{
    ...
    <div class="container mx-auto px-4 sm:px-8">
        ...
        <TextArea style={{ width: '10%', height: '5px' }} placeholder="ID" autoSize onChange={(e) => { }} />
        <br/>
        <b/>
        <TextArea style={{ width: '30%', height: '5px' }} placeholder="FullName" autoSize onChange={(e) => { }} />
        <TextArea style={{ width: '10%', height: '5px' }} placeholder="Gender" autoSize onChange={(e) => { }} />
        <br />
        <br/>
