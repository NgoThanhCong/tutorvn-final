import { Radio, DatePicker, Upload, Button, Image, Space, label, Card } from "antd";
...
const InsertTutor = () => {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post("http://localhost:8080/api/v1/tutor/insertTutor", tutorData, {
        headers: {
  ...
  React.useEffect(() => {
    const url_subjectList = "http://localhost:8080/api/v1/subject/getsubject";
          ...
          <div className="m-5">
            ...
            + Add User Account
                ...
                <div className="w-1/2">
                  ...
                  <TextArea
                    rows={4}
                    placeholder="Description your experients"
                    maxLength={400}
                  ...
                  <br />
                  {/* <Space className="text-white font-semibold" direction="vertical">
        <label>List of subjects</label>
        {
          listSubject.map((item, i) => (
            <Radio checked={false} value={i}>{item.category}</Radio>
          ))
        }
      </Space> */}
